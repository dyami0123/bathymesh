...
if __name__ == "__main__":
    ...
    image_path = data_dir / "raw" / "daria.png"
    save_path = data_dir / "processed" / "daria.npy"

    fuzz = 21.0  # Color matching tolerance

    color_map = {
        "#cdcdcd": {"value": 0, "fuzziness": fuzz},
        "#888888": {"value": 3, "fuzziness": fuzz},
        "#7e7e7e": {"value": 5, "fuzziness": fuzz},
        "#5f5f5f": {"value": 8, "fuzziness": fuzz},
        "#252525": {"value": 5, "fuzziness": fuzz},
        "#D3B9B2": {"value": 15, "fuzziness": fuzz},
        "#8F544F": {"value": 20, "fuzziness": fuzz},
        "#372225": {"value": 10, "fuzziness": fuzz},
    }
    ...
    heightmap_plot(
        data=heightmap_data,
        save_path=data_dir / "processed" / "daria.png",
    )
