...
if __name__ == "__main__":
    ...
    heightmap_path = data_dir / "processed" / "europa.npy"
    ...
    thresholds = [x for x in np.linspace(0, 50, 10)]  # Height thresholds
    ...
    generated_mesh, generator = generate_mesh(
        ...
        contour_extraction_min_area_fraction=0.01,
        # Combiner
    ...
    if create_visuals:
        ...
        save_path = data_dir / "debug_outs" / "eruopa_contours.png"
