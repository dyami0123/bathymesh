...
if __name__ == "__main__":
    ...
    heightmap_path = data_dir / "processed" / "daria.npy"
    save_mesh_path = data_dir / "meshes" / "daria.stl"
    ...
    thresholds = [x for x in np.linspace(0, 22, 10)]  # Height thresholds
    ...
    if create_visuals:
        save_path = data_dir / "debug_outs" / "daria_contours.png"
