...
from bathymesh.data_structures import MeshInfo
...
class TestBathymeshWorkflow:
    ...
    def test_create_mesh_with_coordinates(self, test_heightmap, default_scaling, coordinate_arrays):
    ...
    def test_create_mesh_with_output_path(self, test_heightmap, default_scaling, temp_output_dir):
    ...
    def test_create_multi_level_mesh_with_spacing(self, test_heightmap, default_scaling):
    ...
    def test_contour_mesh_missing_threshold_autofills_value(self, test_heightmap, default_scaling):
    ...
    def test_mesh_output_file_formats(self, test_heightmap, default_scaling, temp_output_dir):
